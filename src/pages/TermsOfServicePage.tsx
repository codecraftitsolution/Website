  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden flex flex-col">
      <SEO 
        ...
        description="Review the Terms and Conditions for using Code Cryptical IT Innovators's services and website."
      />
      <Header />
      ...
      >
        ...
        <div className="glass-card p-8 md:p-12 rounded-2xl border border-white/10 backdrop-blur-md bg-black/40 prose prose-invert max-w-none">
          <p className="lead text-xl mb-8">
            These Terms & Conditions ("Terms") govern the use of services provided by Code Cryptical IT Innovators.
          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-muted-foreground">
                Code Cryptical IT Innovators provides IT and software development services according to a mutually agreed project scope.
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-3">Code Cryptical IT Innovators is not responsible for delays caused by the client.</p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
                <li>All project assets remain the property of Code Cryptical IT Innovators until full payment is received.</li>
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-3">Code Cryptical IT Innovators may terminate a project if:</p>
              <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
